...
public class ChoucairAcademyStepDefinitions {
    ...
    public void thanPetterWantsToLearnAutomationAtTheAcademyChoucair(List<AcademyChoucairData> academyChoucairData) throws Exception{
        OnStage.theActorCalled("Petter").wasAbleTo(OpenUp.thePage(), (Login.
